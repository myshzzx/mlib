...
public class RpcUtil {
    ...
    public static <I> TServer exportTServer(
        ...
        f.setNonTLSServerMaxFrameSize(THRIFT_MAX_FRAME_SIZE);
        return f.build();
    }

    private static <I> TClusterService.Iface wrapService(
            Class<I> svIf, I sv, Map<String, ClassLoader> loaders) {
    ...
    public static <I> IFaceHolder<I> getClient(
            Class<I> svIf, String svHost, int svPort, int timeout, Map<String, ClassLoader> loaders) throws Throwable {
        ...
        conf.setClientSocketTimeout(timeout);
        conf.setNonTLSServerMaxFrameSize(THRIFT_MAX_FRAME_SIZE);
