...
public class X11Provider extends Provider {
	...
	private List<X11HotKey> hotKeys = new CopyOnWriteArrayList<>();
	...
	public void unregister(MediaKey mediaKey, HotKeyListener listener) {
		X11HotKey hotkey = new X11HotKey(mediaKey, listener);
		unregisterKey(hotkey);
	}
