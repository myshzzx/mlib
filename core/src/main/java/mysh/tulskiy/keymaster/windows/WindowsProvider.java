...
import static com.sun.jna.platform.win32.User32.MSG;
import static com.sun.jna.platform.win32.User32.WM_HOTKEY;
...
public class WindowsProvider extends Provider {
	...
	private Map<Integer, HotKey> hotKeys = new ConcurrentHashMap<>();
	...
	private void unregisterKey(HotKey hotkey) {
		...
		for (Map.Entry<Integer, HotKey> e : hotKeys.entrySet()) {
