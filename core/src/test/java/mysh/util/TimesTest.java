...
public class TimesTest {
	...
	public void convert() {
		// GMT冬季标准时 utc+0
		LocalDateTime dt = Times.parseDayTime(Times.Formats.DayTime, "2019-12-01 02:00:00");
		System.out.println(Times.convert(dt, Times.zoneGMT, Times.zoneBJ));
		
		// 夏季夏令时 utc+1
		dt = Times.parseDayTime(Times.Formats.DayTime, "2019-07-01 02:00:00");
		System.out.println(Times.convert(dt, Times.zoneGMT, Times.zoneBJ));
	}
}
