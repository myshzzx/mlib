...
public class RegExpTest extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        chkDotAll.setFont(chkDotAll.getFont());
        chkDotAll.setSelected(true);
        chkDotAll.setText("dot all");
        chkDotAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkDotAllActionPerformed(evt);
            }
        });
	...
	private void chkDotAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkDotAllActionPerformed
		this.testReg();
	}//GEN-LAST:event_chkDotAllActionPerformed
			...
			Thread t = new Thread() {
				...
				public void run() {
					try {
						...
						int expFlag = 0;
						expFlag |= chkDotAll.isSelected() ? Pattern.DOTALL : 0;

						Matcher matcher = compile(reg, expFlag).matcher(text);
						if (matcher.find()) {
							result = matcher.group().equals(text) ? Color.GREEN : Color.BLUE;
						} else {
							result = Color.RED;
						}
						panelResult.setBackground(result);
